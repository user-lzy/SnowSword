...
Help=
Index=-1
Menu=刷新FrmMain_mnuService_mnuRefresh0-10-FrmMain_mnuService_Step10-10启动服务FrmMain_mnuService_mnuStartService0-10停止服务FrmMain_mnuService_mnuStopService0-10暂停服务FrmMain_mnuService_mnuPauseService0-10恢复服务FrmMain_mnuService_mnuContinueService0-10删除服务FrmMain_mnuService_mnuDeleteService0-10-FrmMain_mnuService_mnuStep20-10转到进程FrmMain_mnuService_mnuGotoProcess0-10复制FrmMain_mnuService_mnuCopy0-10{复制单格数据FrmMain_mnuService_mnuLittleCopy0-10}定位文件位置FrmMain_mnuService_mnuLocateFilePath0-10
Left=420
Top=220
Tag=
...
Help=
Index=-1
Menu=刷新FrmMain_mnuWfpCallout_mnuRefresh0-10移除CalloutFrmMain_mnuWfpCallout_mnuRemoveCallout0-10-FrmMain_mnuWfpCallout_mnuStep10-10查看/编辑内存FrmMain_mnuWfpCallout_mnuEditMemory0-10
Left=340
Top=280
Tag=
...
Help=
Index=-1
Menu=刷新FrmMain_mnuWfpFilter_mnuRefresh0-10移除FilterFrmMain_mnuWfpFilter_mnuRemoveFilter0-10-FrmMain_mnuWfpFilter_mnuStep10-10转到相关WfpCalloutFrmMain_mnuWfpFilter_mnuGotoWfpCallout0-10
Left=380
Top=280
Tag=
...
Help=
Index=-1
Menu=刷新FrmMain_mnuProcess_mnuRefresh0-10结束进程FrmMain_mnuProcess_mnuTerminateProcess0-10强制结束进程FrmMain_mnuProcess_mnuForceTerminateProcess0-10暴力结束进程FrmMain_mnuProcess_mnuViolentTerminateProcess0-10挂起进程FrmMain_mnuProcess_mnuSuspendProcess0-10恢复进程FrmMain_mnuProcess_mnuResumeProcess0-10保护进程FrmMain_mnuProcess_mnuProtectProcess0-10检测隐藏进程FrmMain_mnuProcess_mnuCheckHideProcess0-10-FrmMain_mnuProcess_mnuStep1000注入DLLFrmMain_mnuProcess_mnuInjectDll0-10-FrmMain_mnuProcess_mnuStep20-10查看模块FrmMain_mnuProcess_mnuViewModule0-10查看线程FrmMain_mnuProcess_mnuViewThread0-10查看内存FrmMain_mnuProcess_mnuViewMemory0-10查看...FrmMain_mnuProcess_mnuView0-10{查看窗口列表FrmMain_mnuProcess_mnuViewWindowList0-10查看句柄列表FrmMain_mnuProcess_mnuViewHandleList0-10查看网络连接列表FrmMain_mnuProcess_mnuViewWebConnect0-10查看特权FrmMain_mnuProcess_mnuViewPrivilege0-10查看HookFrmMain_mnuProcess_mnuViewHook0-10查看进程定时器FrmMain_mnuProcess_mnuViewProcessTimer0-10查看消息钩子FrmMain_mnuProcess_mnuViewMsgHook0-10查看事件钩子FrmMain_mnuProcess_mnuViewEventHook0-10查看热键FrmMain_mnuProcess_mnuViewHotkey0-10查看其他信息FrmMain_mnuProcess_mnuViewOtherInfo0-10}-FrmMain_mnuProcess_mnuStep30-10复制FrmMain_mnuProcess_mnuCopy0-10{复制单格FrmMain_mnuProcess_mnuLittleCopy0-10}定位文件位置(文件管理器)FrmMain_mnuProcess_mnuLocateFile0-10定位文件位置(资源浏览器)FrmMain_mnuProcess_mnuLocateFileByExplorer0-10
Left=380
Top=220
Tag=
...
Dim Shared hSysImageList As HIMAGELIST
...
Function ToolTipSubclassProc ( _
    ByVal hWnd As HWND, _
    ByVal uMsg As UINT, _
    ByVal wParam As WPARAM, _
    ByVal lParam As LPARAM, _
    ByVal uIdSubclass As UINT_PTR, _
    ByVal dwRefData As DWORD_PTR _
) As LRESULT
    ...
    Select Case uMsg
        ...
        Case WM_MOUSEMOVE
            ...
            Dim x As Integer = CInt(CShort(LoWord(lParam)))
            Dim y As Integer = CInt(CShort(HiWord(lParam)))

            MyLog.PrintInfo "ToolTipSubclassProc", "ToolTip WM_MOUSEMOVE", _
                "x=" & x & _
                "y=" & y

        Case WM_MOUSELEAVE

            MyLog.PrintInfo "ToolTipSubclassProc", "ToolTip WM_MOUSELEAVE", _
                "WM_MOUSELEAVE"
        ...
        Case WM_NCMOUSEMOVE
            ...
            MyLog.PrintInfo "ToolTipSubclassProc", "ToolTip WM_NCMOUSEMOVE", _
                "x=" & x & _
                "y=" & y

        Case WM_NCMOUSELEAVE

            MyLog.PrintInfo "ToolTipSubclassProc", "ToolTip WM_NCMOUSELEAVE", _
                "WM_NCMOUSELEAVE"

        Case WM_TIMER

            'MyLog.PrintInfo "ToolTipSubclassProc", "ToolTip WM_TIMER", _
            '    "timer=" & CULng(wParam)

        Case TTM_POP
            Dim ptCursor As POINT
            Dim rcTooltip As RECT
            Dim ptCursorScreen As POINT

            ' 获取鼠标屏幕坐标（通过消息参数 lParam 或 GetCursorPos）
            ' TTM_POP 的 lParam/wParam 通常不包含坐标，所以用 GetCursorPos
            GetCursorPos(@ptCursorScreen)

            ' 获取 Tooltip 窗口位置和大小
            GetWindowRect(hWnd, @rcTooltip)

            MyLog.PrintInfo "ToolTipSubclassProc", "ToolTip TTM_POP", _
                "mouseScreenX=" & ptCursorScreen.x & _
                " mouseScreenY=" & ptCursorScreen.y & _
                " tooltipLeft=" & rcTooltip.left & _
                " tooltipTop=" & rcTooltip.top & _
                " tooltipRight=" & rcTooltip.right & _
                " tooltipBottom=" & rcTooltip.bottom & _
                " tooltipWidth=" & (rcTooltip.right - rcTooltip.left) & _
                " tooltipHeight=" & (rcTooltip.bottom - rcTooltip.top)

        Case TTM_UPDATE

            MyLog.PrintInfo "ToolTipSubclassProc", "ToolTip TTM_UPDATE", _
                "TTM_UPDATE"

        Case TTM_RELAYEVENT
            Dim pMsg As MSG Ptr = CPtr(MSG Ptr, lParam)
            
            ' 获取实际鼠标屏幕坐标
            Dim ptScreen As Point
            GetCursorPos(@ptScreen)
            
            ' 转换为相对于工具窗口（ListView）的客户坐标
            Dim hwndTool As hWnd = pMsg->hWnd ' 通常是 ListView 的 hwnd
            Dim ptClient As Point = ptScreen
            ScreenToClient(hwndTool, @ptClient)
            
            ' 修正 MSG 结构
            ' lParam 需要包含客户坐标 (MAKELPARAM)
            pMsg->lParam = MAKELPARAM(Cast(WORD, ptClient.x), Cast(WORD, ptClient.y))
            
            ' pt 需要包含屏幕坐标
            pMsg->pt = ptScreen
            
            ' 确保 message 正确
            ' pMsg->message 应该已经是 WM_MOUSEMOVE (0x200)
            
            ' 现在传递给原始的 tooltip 窗口过程
...
Function ListViewSubclassProc ( _
    ByVal hWnd As HWND, _
    ByVal uMsg As UINT, _
    ByVal wParam As WPARAM, _
    ByVal lParam As LPARAM, _
    ...
    Select Case uMsg
        ...
        Case WM_MOUSEMOVE
            ...
            Dim item As Integer = ListView_HitTest(hWnd, @ht)

            MyLog.PrintInfo "ListViewSubclassProc", "LV WM_MOUSEMOVE", _
                "x=" & x & _
                "y=" & y & _
                "item=" & item
        ...
        Case WM_MOUSELEAVE
            ...
            MyLog.PrintInfo "ListViewSubclassProc", "LV WM_MOUSELEAVE", _
                "WM_MOUSELEAVE"
        ...
        Case WM_NCMOUSEMOVE
            ...
            MyLog.PrintInfo "ListViewSubclassProc", "LV WM_NCMOUSEMOVE", _
                "x=" & x & _
                "y=" & y

        Case WM_NCMOUSELEAVE

            MyLog.PrintInfo "ListViewSubclassProc", "LV WM_NCMOUSELEAVE", _
                "WM_NCMOUSELEAVE"
            ...
            If hdr <> 0 Then
                ...
                Select Case hdr->code
                    ...
                    Case LVN_GETINFOTIPW
                        ...
                        Dim info As NMLVGETINFOTIPW Ptr = _
                            Cast(NMLVGETINFOTIPW Ptr, lParam)

                        If info <> 0 Then

                            MyLog.PrintInfo "ListViewSubclassProc", "LVN_GETINFOTIP", _
                                "GETINFOTIP item=" & info->iItem & _
                                "sub=" & info->iSubItem
                    ...
                    Case LVN_GETINFOTIPA
                        ...
                        Dim info As NMLVGETINFOTIPA Ptr = _
                            Cast(NMLVGETINFOTIPA Ptr, lParam)
...
Sub UpdateLayout()
    ' 常量定义（可按需调整参数）
    #define TOP_BAR_HEIGHT     40    ' 顶部控制栏统一高度（路径栏/筛选栏通用）
    #define FILTER_BOX_WIDTH   220   ' 筛选框固定宽度
    #define CTRL_HORZ_PADDING  8     ' 控件水平间距
    ...
    Dim mainAreaLeft As Long = treMain.Width    ' 主区域左边界
    Dim mainAreaWidth As Long = cw - mainAreaLeft ' 主区域总宽度
    ...
    Case LAYOUT_LIST_TREE
        ...
        txtFilePath.Left = mainAreaLeft
        txtFilePath.Top = 0
        txtFilePath.Width = mainAreaWidth - FILTER_BOX_WIDTH - CTRL_HORZ_PADDING
        txtFilePath.Height = TOP_BAR_HEIGHT
        SetWindowZ txtFilePath.hWnd

        TxtFilter2.Visible = True
        TxtFilter2.Left = txtFilePath.Left + txtFilePath.Width + CTRL_HORZ_PADDING
        TxtFilter2.Width = FILTER_BOX_WIDTH
        TxtFilter2.Top = (TOP_BAR_HEIGHT - TxtFilter2.Height) \ 2 ' 垂直居中
        SetWindowZ TxtFilter2.hWnd

        topOffset = TOP_BAR_HEIGHT

    Case LAYOUT_LIST_ONLY
        ' --- 纯列表页（进程/内核/模块等）：顶部仅筛选框 ---
        TxtFilter2.Visible = True
        TxtFilter2.Left = mainAreaLeft
        TxtFilter2.Width = mainAreaWidth ' FILTER_BOX_WIDTH
        TxtFilter2.Top = (TOP_BAR_HEIGHT - TxtFilter2.Height) \ 2 ' 垂直居中
        SetWindowZ TxtFilter2.hWnd
    ...
    ' ========== 4. 底部状态栏 & 主体可用高度 ==========
    Dim bottomBarTop As Long
    Dim mainHeight As Long

    Select Case gLayoutMode
    Case LAYOUT_LIST_TREE, LAYOUT_LIST_ONLY
        ' 带列表的页面：显示底部状态栏，占满主区域全宽
        lblNum.Visible = True
        lblNum.Left = mainAreaLeft
        lblNum.Width = mainAreaWidth
        bottomBarTop = ch - lblNum.Height
        lblNum.Top = bottomBarTop
        'SetWindowZ lblNum.hWnd

        mainHeight = bottomBarTop - topOffset

    Case LAYOUT_NONE
        ' 无列表页：无状态栏，内容区占满全高
        bottomBarTop = ch
        mainHeight = ch - topOffset
    End Select

    ' ========== 5. 主体内容布局（原有逻辑复用，变量统一） ==========
    Select Case gLayoutMode

    Case LAYOUT_LIST_TREE
        TreeView.Visible = True
        SetWindowZ TreeView.hWnd
        TreeView.Left = mainAreaLeft
        TreeView.Top = topOffset
        TreeView.Width = mainAreaWidth \ 2
        ...
        ListView1.Width = mainAreaWidth - TreeView.Width
    ...
    Case LAYOUT_LIST_ONLY
        ...
        If ListView1.Visible Then
            ListView1.Left = mainAreaLeft
            ListView1.Top = topOffset
            ListView1.Width = mainAreaWidth
            ListView1.Height = mainHeight
            SetWindowZ ListView1.hWnd
        Else
            mCtrlTreeList1.Left = mainAreaLeft
            mCtrlTreeList1.Top = topOffset
            mCtrlTreeList1.Width = mainAreaWidth
    ...
    Case LAYOUT_NONE
        ...
        FmeAdvance.Left = mainAreaLeft
        FmeAdvance.Top = topOffset
        FmeAdvance.Width = mainAreaWidth
...
'[FrmMain]事件 : 完成创建窗口及所有的控件后，此时窗口还未显示。注：自定义消息里 WM_Create 此时还未创建控件和初始赋值。
...
Sub FrmMain_WM_Create(hWndForm As hWnd,UserData As Integer)
    InitCommandLine
    ' CLI / Agent / Single-shot / 顶层帮助/错误 模式：
    ' 在窗口第一次显示之前就隐藏
    If g_CuiMode OrElse CBool(LenW(g_SingleCommand) > 0) OrElse g_ShowTopHelp OrElse g_ShowVersion OrElse CBool(LenW(g_TopLevelError) > 0) Then
        g_BlockMainWindowShow = True
    End If
    prevFrmMainProc = SetWindowLongPtr(hWndForm, GWL_WNDPROC, Cast(LONG_PTR, @WndProc))
End Sub
...
Sub FrmMain_Shown(hWndForm As hWnd, UserData As Integer)
    ...
    ' ========== 0. 顶层参数错误 / 帮助 / 版本 ==========
    If LenW(g_TopLevelError) > 0 Then
        SafeStdOut(g_TopLevelError & vbCrlfW)
        SafeStdOut("Usage: SnowSword [--cli] [-c ""<command>""] [--format json] [--agent-pipe <name>] [--help] [--version]" & vbCrlfW)
        SafeStdOut("       Command help: -c ""help [category] [action]""" & vbCrlfW)
        ExitProcess(1)
    End If
    If g_ShowVersion Then
        SafeStdOut(App.ProductName & " " & App.FileMajor & "." & App.FileMinor & "." & App.FileRevision & "." & App.FileBuild & vbCrlfW)
        ExitProcess(0)
    End If
    If g_ShowTopHelp Then
        SafeStdOut("Usage: SnowSword [--cli] [-c ""<command>""] [--format json] [--agent-pipe <name>] [--help] [--version]" & vbCrlfW)
        SafeStdOut("  --cli               interactive console mode" & vbCrlfW)
        SafeStdOut("  -c <command>        run one command and exit (quote the command)" & vbCrlfW)
        SafeStdOut("  --format json       output JSON (use with -c / --agent-pipe)" & vbCrlfW)
        SafeStdOut("  --agent-pipe <name> run as named-pipe agent (\\\\.\\pipe\\<name>)" & vbCrlfW)
        SafeStdOut("  --help, -h          show this help" & vbCrlfW)
        SafeStdOut("  --version, -v       show version" & vbCrlfW)
        SafeStdOut("Command help: -c ""help [category] [action]""" & vbCrlfW)
        ExitProcess(0)
    End If

    ' ========== 1. 单次模式判定（重构） ==========
    Dim isSingleShot As Boolean = (LenW(g_SingleCommand) > 0)
    ...
    If isSingleShot Then
        ...
        If hr <> 0 And hr <> 1 Then
            SafeStdOut("COM初始化失败, hr=0x" & Hex(hr) & vbCrlfW)
        End If

        ' 统一单次入口：引号感知分词 + 内联管道/重定向 + 精确退出码
        Dim exitCode As Integer = RunSingleShot(g_SingleCommand)
    ...
    hr = CoInitializeEx(NULL, COINIT_APARTMENTTHREADED)
    If hr <> 0 And hr <> 1 Then
        MyLog.PrintLog LOG_ERROR, "FrmMain_Shown", "CoInitializeEx", "COM初始化失败, hr=0x" & Hex(hr)
    End If
    ...
    Dim CurrentInformation As CURRENT_INFORMATION
    ...
    If Command(1) = "-LoadDriver" And IsAdmin Then
        If (Not IsDriverLoaded) AndAlso (ShowMsgBox("驱动尚未加载,是否加载?",, MB_YESNO) = IDYES) Then
            If InitDriver Then ShowInfoBox "加载成功!" Else ShowErrorBox "加载失败!"
        End If
    End If
...
Sub FrmMain_treMain_WM_LButtonDblclk(hWndForm As hWnd, hWndControl As hWnd, MouseFlags As Long, xPos As Long, yPos As Long)
    ...
    ElseIf SelectText = "内核模块" Then
        ...
        If g_ViewCache(CurrentInformation.intType).IsCached Then
            RestoreListViewFromCache ListView1, CurrentInformation.intType
        Else
            GetKernelModuleList ListView1, False
        End If
        lblNum.Caption = "数量:" & WStr(ListView1.ItemCount)
    ...
    ElseIf SelectText = "GDT" Then
        ...
        Else
            If Not IsDriverLoaded Then 
                ...
                End If
            End If
            GetGDT(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, CurrentInformation.intType
        End If
        SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
    ...
    ElseIf SelectText = "过滤驱动" Then
        ...
        Else
            If Not IsDriverLoaded Then 
                ...
                End If
            End If
            EnumAttachDevices(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, CurrentInformation.intType
        End If
        SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
        lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
    ...
    ElseIf SelectText = "Ndis" Then
        ...
        Else
            If Not IsDriverLoaded Then 
                ...
                End If
            End If
            EnumNdisMiniport(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, CurrentInformation.intType
        End If
        SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
        lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
    ...
    ElseIf SelectText = "WfpCallout" Then
        ...
        Else
            If Not IsDriverLoaded Then 
                ...
                End If
            End If
            If GetSystemVersion <> "Windows 11 24H2" AndAlso GetSystemVersion <> "Windows 10 22H2" AndAlso ShowMsgBox("暂不支持的版本,是否执意继续?",, MB_YESNO) = IDNO Then Exit Sub
    ...
    ElseIf SelectText = "文件" Then
        ...
        If g_ViewCache(CurrentInformation.intType).IsCached Then
            ...
            RestoreListViewFromCache ListView1, CurrentInformation.intType
        Else
            GetDriveList NULL, TreeView, GetMenuCheckState(mnuFolder, FrmMain_mnuFolder_mnuEnablePhysicalAnalyze)
        End If
        lblNum.Caption = "数量:" & WStr(ListView1.ItemCount)
...
Function FrmMain_TreeView_NM_DBLCLK(hWndForm As hWnd, hWndControl As hWnd) As LResult
    ...
    Select Case CurrentInformation.intType
        ...
        Case File
            lblNum.Caption = "正在获取..."
            Dim fileInfo() As WIN32_FILE_DATAEX2W
            If TreeView.GetParent(hClickedItem) <> NULL Then
            ...
            Else
                GetDriveList hClickedItem, TreeView, GetMenuCheckState(mnuFolder, FrmMain_mnuFolder_mnuEnablePhysicalAnalyze)
            End If
            GetPathByNodeW hClickedItem, TreeView, currentPath
...
Sub FrmMain_Check6_BN_Clicked(hWndForm As hWnd, hWndControl As hWnd)
    If (Check6.Value) Then
        If InitDriver Then ShowInfoBox "加载成功!" Else ShowErrorBox "加载失败!" : Check6.Value = 0
    Else
        UninitDriver
        ShowInfoBox "卸载成功!"
        Check3.Value = False
...
Sub FrmMain_TxtFilter2_EN_Change(hWndForm As hWnd, hWndControl As hWnd)
    lblNum.Caption = "正在筛选..."
    If gMainView = VIEW_TREELIST Then
        SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
        lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
    Else
...
Function FrmMain_Custom(hWndForm As hWnd, wMsg As UInteger, wParam As wParam, lParam As lParam) As LResult
    ...
    Case WM_NOTIFY
        ...
        ElseIf Nmhdr->hwndFrom = mCtrlTreeList1.hWnd Then
            Select Case Nmhdr->code
                Case NM_CUSTOMDRAW
                    Return TreeListCustomDraw(lParam)
                Case TVN_KEYDOWN
                    ' 判断 Ctrl + C
...
Sub FrmMain_mnuKernelModule_WM_Command(hWndForm As hWnd,wID As ULong)
    Select Case wID
        Case FrmMain_mnuKernelModule_mnuRefresh ' 刷新
            lblNum.Caption = "正在刷新..."
            GetKernelModuleList ListView1, GetMenuCheckState(mnuKernelModule, FrmMain_mnuKernelModule_mnuCheckHideDriver)
        ...
        Case FrmMain_mnuKernelModule_mnuCheckHideDriver ' 检测隐藏驱动
            ...
            GetKernelModuleList ListView1, Not bState
        ...
        Case FrmMain_mnuKernelModule_mnuLittleCopy ' 复制单格数据
            ...
            End If
        Case FrmMain_mnuKernelModule_mnuLocateFile ' 定位文件位置(文件管理器)
            Dim lpFilePath As StringW = ListView1.GetItemText(ListView1.SelectedItem, 4)
            If Not LocateFilePath(lpFilePath) Then ShowErrorBox "未找到文件位置!"
        Case FrmMain_mnuKernelModule_mnuLocateFileByExplorer ' 定位文件位置(资源浏览器)
            Dim lpFilePath As StringW = ListView1.GetItemText(ListView1.SelectedItem, 4)
            If Not LocateFilePathByExplorer(lpFilePath) Then ShowErrorBox "定位失败!"
   End Select
End Sub
        ...
        Select Case CurrentInformation.intType
            Case File
                If (GetFileAttributes(strPath) And fbDirectory) = fbDirectory Then ' 是目录,跳转过去
                    CurrentNode = GetNodeByFolderPathW(strPath, TreeView, ListView1) ' 查找并获取对应Node
...
Sub FrmMain_WM_Size(hWndForm As hWnd, fwSizeType As Long, nWidth As Long, nHeight As Long)
    ...
    If fwSizeType = SIZE_RESTORED Or fwSizeType = SIZE_MAXIMIZED Then UpdateLayout
End Sub
...
Function WndProc(ByVal hWnd As HWND, ByVal uMsg As UINT, ByVal wParam As WPARAM, ByVal lParam As LPARAM) As LRESULT
    ...
    Select Case uMsg
        ...
        Case WM_SHOWWINDOW
            If g_BlockMainWindowShow AndAlso wParam <> 0 Then Return 0
        Case WM_WINDOWPOSCHANGING
            If g_BlockMainWindowShow Then
                Dim pWindowPos As WINDOWPOS Ptr
...
Sub FrmMain_mnuProcess_WM_Command(hWndForm As hWnd, wID As ULong)
    ...
    Select Case wID
        ...
        Case FrmMain_mnuProcess_mnuTerminateProcess ' 结束进程
            ...
            For i As Integer = ListView1.ItemCount - 1 To 0 Step -1
                If IsListViewItemSelected(ListView1, i) Then
                    dwProcessId = ValULng(GetViewItemTextEx(ListView1, i, 0))
        ...
        Case FrmMain_mnuProcess_mnuForceTerminateProcess '强制结束进程
            ...
            For i As Integer = ListView1.ItemCount - 1 To 0 Step -1
                If IsListViewItemSelected(ListView1, i) Then
                    Dim dwPID As HANDLE = Cast(HANDLE, ValLng(GetViewItemTextEx(ListView1, i, 0)))
                    Dim IsCritical As Boolean
                    If (IsProcessCritical(dwProcessId, @IsCritical)) AndAlso IsCritical Then
                        If ShowMsgBox("进程" & dwProcessId & "处于Critical状态,强行结束可能蓝屏,是否结束?", "提示", MB_YESNO) = IDYES Then
        ...
        Case FrmMain_mnuProcess_mnuViolentTerminateProcess '暴力结束进程
            Dim dwProcessId As HANDLE = Cast(HANDLE, ValULng(GetViewItemTextEx(ListView1, ListView1.SelectedItem, 0)))
            If Not IsDriverLoaded Then 
                If ShowMsgBox("驱动尚未加载,是否加载?",, MB_YESNO) = IDYES Then
                    If InitDriver Then ShowInfoBox "加载成功!" Else ShowErrorBox "加载失败!" : Return
                Else
        ...
        Case FrmMain_mnuProcess_mnuSuspendProcess ' 挂起进程
            ...
            For i As Integer = ListView1.ItemCount - 1 To 0 Step -1
                If IsListViewItemSelected(ListView1, i) Then
                    dwProcessId = ValULng(GetViewItemTextEx(ListView1, ListView1.SelectedItem, 0))
                    If Not SuspendProcess(dwProcessId) Then ShowErrorBox "挂起进程" & dwProcessId & "失败!" 
                End If
            Next
        Case FrmMain_mnuProcess_mnuResumeProcess ' 恢复进程
            ...
            For i As Integer = ListView1.ItemCount - 1 To 0 Step -1
                If IsListViewItemSelected(ListView1, i) Then
                    dwProcessId = ValULng(GetViewItemTextEx(ListView1, ListView1.SelectedItem, 0))
                    If Not ResumeProcess(dwProcessId) Then ShowErrorBox "恢复进程" & dwProcessId & "失败!" 
                End If
            Next
        Case FrmMain_mnuProcess_mnuProtectProcess
            If Not IsDriverLoaded Then 
                ...
                End If
            End If
            Dim dwProcessId As DWORD = ValULng(GetViewItemTextEx(ListView1, ListView1.SelectedItem, 0)), ret As Long, lpRet As DWORD
            IoControl hDrv, IOCTL_AddProtectedProcess, @dwProcessId, SizeOf(DWORD)
        Case FrmMain_mnuProcess_mnuCheckHideProcess '检测隐藏进程
            If (Not GetMenuCheckState(mnuProcess, FrmMain_mnuProcess_mnuCheckHideProcess)) AndAlso (Not IsDriverLoaded) AndAlso (ShowMsgBox("驱动尚未加载,是否加载?",, MB_YESNO) = IDYES) Then
                If InitDriver Then ShowInfoBox "加载成功!" Else ShowErrorBox "加载失败!" : Exit Sub
            End If
        ...
        Case FrmMain_mnuProcess_mnuInjectDll ' 注入DLL
            ...
            If szFile <> "" Then If RemoteInjectDll(CurrentInfo->ProcessId, szFile) Then ShowInfoBox "注入成功!" Else ShowErrorBox "注入失败!"
        ...
        Case FrmMain_mnuProcess_mnuViewOtherInfo ' 查看其他信息
            ...
            FrmOtherInfo.Show,, Cast(Integer, CurrentInfo)
        ...
        Case FrmMain_mnuProcess_mnuLittleCopy ' 复制单格数据
            If (LastClickedItem >= 0 AndAlso LastClickedItem <= ListView1.ItemCount - 1) AndAlso _
               (LastClickedSubItem >= 0 AndAlso LastClickedSubItem <= ListView1.ColumnCount - 1) Then
                CopyDataToClipboard GetViewItemTextEx(ListView1, LastClickedItem, LastClickedSubItem)
            End If
        Case FrmMain_mnuProcess_mnuLocateFile ' 定位文件位置(文件管理器)
            Dim lpFilePath As StringW = GetViewItemTextEx(ListView1, ListView1.SelectedItem, 4)
            If Not LocateFilePath(lpFilePath) Then ShowErrorBox "未找到文件位置!"
        Case FrmMain_mnuProcess_mnuLocateFileByExplorer ' 定位文件位置(资源浏览器)
            Dim lpFilePath As StringW = GetViewItemTextEx(ListView1, ListView1.SelectedItem, 4)
            If Not LocateFilePathByExplorer(lpFilePath) Then ShowErrorBox "未找到文件位置!"
    End Select
End Sub
    ...
    Select Case wID
        ...
        Case FrmMain_mnuCallbacks_mnuRemoveCallback ' 移除回调
            ...
            If (IsDriverLoaded AndAlso CallbackAddress <> NULL) Then
                ...
                End If
            End If
        Case FrmMain_mnuCallbacks_mnuGotoDriver ' 转到驱动
            Dim DriverPath As StringW = GetViewItemTextEx(ListView1, ListView1.SelectedItem, 2)
            SwitchToModule "内核模块"
            If Not FindDriverInListView(ListView1, DriverPath) Then ShowErrorBox "未找到驱动!"
...
Sub FrmMain_mnuService_WM_Command(hWndForm As hWnd,wID As ULong)
    Select Case wID
        ...
        Case FrmMain_mnuService_mnuStartService ' 启动服务
            If MyStartService(ListView1.GetItemText(ListView1.SelectedItem, 0)) Then ShowInfoBox "启动成功!" Else ShowErrorBox "启动失败!"
        Case FrmMain_mnuService_mnuStopService ' 停止服务
            If MyStopService(ListView1.GetItemText(ListView1.SelectedItem, 0)) Then ShowInfoBox "停止成功!" Else ShowErrorBox "停止失败!"
        Case FrmMain_mnuService_mnuPauseService ' 暂停服务
            If MyPauseService(ListView1.GetItemText(ListView1.SelectedItem, 0)) Then ShowInfoBox "暂停成功!" Else ShowErrorBox "暂停失败!"
        Case FrmMain_mnuService_mnuContinueService ' 恢复服务
            If MyContinueService(ListView1.GetItemText(ListView1.SelectedItem, 0)) Then ShowInfoBox "恢复成功!" Else ShowErrorBox "恢复失败!"
        Case FrmMain_mnuService_mnuDeleteService ' 删除服务
            If MyDeleteService(ListView1.GetItemText(ListView1.SelectedItem, 0)) Then ShowInfoBox "删除成功!" Else ShowErrorBox "删除失败!"
        Case FrmMain_mnuService_mnuGotoProcess ' 转到进程
            Dim PID As DWORD = ValUInt(ListView1.GetItemText(ListView1.SelectedItem, 4))
            SwitchToModule "进程"
            If Not FindProcessInListView(FrmMain.ListView1, PID) Then ShowErrorBox "未找到进程!"
...
Sub FrmMain_mnuWinsockSPI_WM_Command(hWndForm As hWnd,wID As ULong)
    Select Case wID
        ...
        Case FrmMain_mnuWinsockSPI_mnuRemove ' 移除
            If RemoveWinsockSPI(ListView1.GetItemText(ListView1.SelectedItem, 3), ListView1.GetItemText(ListView1.SelectedItem, 1)) Then
                ShowInfoBox "移除成功!"
...
Sub FrmMain_mnuKernelThread_WM_Command(hWndForm As hWnd, wID As ULong)
    Dim SelectIndex As Integer = ListView1.SelectedItem
    Dim dwThreadId As DWORD = ValUInt(ListView1.GetItemText(SelectIndex, 0))
    Select Case wID
        ...
        Case FrmMain_mnuKernelThread_GotoDriver ' 转到驱动
            Dim DriverPath As StringW = UCaseW(ListView1.GetItemText(SelectIndex, 5))
            SwitchToModule("内核模块")
            For i As Integer = 0 To ListView1.ItemCount - 1
                If UCaseW(ListView1.GetItemText(i, 4)) = DriverPath Then
...
Sub FrmMain_mnuFilterDriver_WM_Command(hWndForm As hWnd,wID As ULong)
    Select Case wID
        Case FrmMain_mnuFilterDriver_mnmuRefresh ' 刷新
            ...
            InitializeTreeList FilterDriver, mCtrlTreeList1
            EnumAttachDevices(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, FilterDriver
            SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
            lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
...
Sub FrmMain_mnuMinifilter_WM_Command(hWndForm As hWnd,wID As ULong)
    Select Case wID
        Case FrmMain_mnuMinifilter_mnuRefresh ' 刷新
            ...
            InitializeTreeList Minifilter, mCtrlTreeList1
            EnumMinifilter(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, Minifilter
            SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
            lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
...
Sub FrmMain_mnuWfpFilter_WM_Command(hWndForm As hWnd, wID As ULong)
    ...
    Select Case wID
        Case FrmMain_mnuWfpFilter_mnuRefresh ' 刷新
            ...
            GetWfpFilterList ListView1
            lblNum.Caption = "数量:" & ListView1.ItemCount
        Case FrmMain_mnuWfpFilter_mnuGotoWfpCallout ' 转到相关WfpCallout
            Dim CalloutGUID As StringW = UCaseW(ListView1.GetItemText(SelectIndex, 4))
            SwitchToModule("WfpCallout")
            For i As Integer = 0 To ListView1.ItemCount - 1
                If UCaseW(ListView1.GetItemText(i, 0)) = CalloutGUID Then
                    ListView1.SelectedItem = i
                    ListView_EnsureVisible(ListView1.hWnd, i, False)
                    Return
                End If
            Next
            ShowErrorBox "未找到WfpCallout!"
    End Select
End Sub
...
Sub FrmMain_mnuGDT_WM_Command(hWndForm As hWnd,wID As ULong)
    Select Case wID
        Case FrmMain_mnuGDT_mnuRefresh ' 刷新
            ...
            InitializeTreeList GDT, mCtrlTreeList1
            GetGDT(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, GDT
            SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
            lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
...
Sub FrmMain_mnuIDT_WM_Command(hWndForm As hWnd,wID As ULong)
    Select Case wID
        Case FrmMain_mnuIDT_mnuRefresh ' 刷新
            ...
            InitializeTreeList IDT, mCtrlTreeList1
            GetIDT(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, IDT
            SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
            lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
...
'[FrmMain.mnuTaskScheduler]事件 : 点击了菜单项
'hWndForm 当前窗口的句柄(WIN系统用来识别窗口的一个编号，如果多开本窗口，必须 Me.hWndForm = hWndForm 后才可以执行后续操作本窗口的代码)
''           本控件为功能控件，就是无窗口，无显示，只有功能。如果多开本窗口，必须 Me.控件名.hWndForm = hWndForm 后才可以执行后续操作本控件的代码 
'wID      菜单项命令ID
Sub FrmMain_mnuTaskScheduler_WM_Command(hWndForm As hWnd, wID As ULong)
    Dim SelectIndex As Long = ListView1.SelectedItem
    Dim taskPath As String = ListView1.GetItemText(SelectIndex, 1)
    Dim ret As Long = 0
    Select Case wID
        ...
        Case FrmMain_mnuTaskScheduler_mnuEnable ' 启用
            ret = SetTaskEnabled(taskPath, True)
            If ret = 0 Then
                ShowInfoBox "启用成功!"
            Else
                MyLog.PrintLog LOG_ERROR, "FrmMain_mnuTaskScheduler_mnuEnable", "SetTaskEnabled", "ret=" & ret
                ShowErrorBox "启用失败!"
            End If
        Case FrmMain_mnuTaskScheduler_mnuRun ' 运行
            ret = RunTask(taskPath)
            If ret = 0 Then
                ShowInfoBox "运行成功!"
            Else
                MyLog.PrintLog LOG_ERROR, "FrmMain_mnuTaskScheduler_mnuRun", "RunTask", "ret=" & ret
                ShowErrorBox "运行失败!"
            End If
        Case FrmMain_mnuTaskScheduler_mnuDelete ' 删除
            ret = DeleteTask(taskPath)
            If ret = 0 Then
                ShowInfoBox "删除成功!"
            Else
                MyLog.PrintLog LOG_ERROR, "FrmMain_mnuTaskScheduler_mnuDelete", "DeleteTask", "ret=" & ret
                ShowErrorBox "删除失败!"
            End If
        Case FrmMain_mnuTaskScheduler_mnuGotoProcess ' 转到进程
            Dim ProgramPath As StringW = UCaseW(ListView1.GetItemText(SelectIndex, 7))
            SwitchToModule("进程")
            If Not FindProcessInListView(FrmMain.ListView1, ProgramPath) Then ShowErrorBox "未找到进程!"
    End Select
End Sub
...
Sub FrmMain_mnuNdis_WM_Command(hWndForm As hWnd,wID As ULong)
   Select Case wID
        Case FrmMain_mnuNdis_mnuRefresh ' 刷新
            ...
            InitializeTreeList Ndis, mCtrlTreeList1
            EnumNdisMiniport(mCtrlTreeList1)
            CaptureTreeListData mCtrlTreeList1, Ndis
            SetTreeListFilter mCtrlTreeList1, TxtFilter2.Text
            lblNum.Caption = "数量:" & WStr(GetTreeListVisibleItemCount(mCtrlTreeList1))
        Case FrmMain_mnuNdis_mnuEditMemory ' 查看/编辑内存
